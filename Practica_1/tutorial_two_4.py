...
class tutorial_two_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Practica_1_2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Practica_1_2")
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.blocks_throttle_1, 0))
