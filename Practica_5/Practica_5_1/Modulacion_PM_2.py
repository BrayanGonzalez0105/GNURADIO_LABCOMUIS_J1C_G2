...
# Title: Modulacion_PM_2
# Author: Brayan_Gonzalez
# Copyright: UIS
# Description: Practica_5_1_2
...
class Modulacion_PM_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Modulacion_PM_2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulacion_PM_2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Modulacion_PM_2")
        ...
        self._Am_range = Range(0, 50, 1, 1, 200)
...
def main(top_block_cls=Modulacion_PM_2, options=None):
