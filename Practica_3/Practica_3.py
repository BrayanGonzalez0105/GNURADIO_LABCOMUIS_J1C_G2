...
class Practica_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Practica_3_1", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica_3")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 1200, 1, 0, 0)
...
def main(top_block_cls=Practica_3, options=None):
