...
from Modulador_SSB import Modulador_SSB  # grc-generated hier_block
...
class Transmisor_SSB(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Transmisor_SSB", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Transmisor_SSB")
        ...
        self.Modulador_SSB_0 = Modulador_SSB(
            Ac=Ac,
            K=K,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Modulador_SSB_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Calculo_Potencia_Comunicaciones_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Modulador_SSB_0, 0))
    ...
    def set_K(self, K):
        self.K = K
        self.Modulador_SSB_0.set_K(self.K)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Modulador_SSB_0.set_Ac(self.Ac)
